...
const SUB_MENU_ROUTES: Record<string, string> = {
  ...
  'Admin/Accounts > Batch Transfer': '/dashboard/account-master/batch-transfer',
  'Admin/Accounts > Batch Cancellation': '/dashboard/account-master/batch-transfer?type=cancelled',
