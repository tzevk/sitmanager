...
const SUB_MENU_ROUTES: Record<string, string> = {
  ...
  'Admin/Accounts > Batch Left': '/dashboard/reports/student?type=left',
  'Admin/Accounts > Batch Moving': '/dashboard/reports/student?type=transferred',
  'Admin/Accounts > Batch Transfer': '/dashboard/reports/student?type=transferred',
  'Admin/Accounts > Batch Cancellation': '/dashboard/reports/student?type=cancelled',
  ...
  'Reports > College Follow Up': '/dashboard/reports/college-follow-up',
...
const SUB_MENU_PERMISSIONS: Record<string, string[]> = {
  ...
  'Admin/Accounts > Batch Left': ['student.view'],
  'Admin/Accounts > Batch Moving': ['student.view'],
  'Admin/Accounts > Batch Transfer': ['student.view'],
  'Admin/Accounts > Batch Cancellation': ['student.view'],
  ...
  'Reports > Corporate Record': ['report_corporate_record.view'],
  'Reports > College Follow Up': ['report_college_followup.view'],
  'Reports > Student Search for Interview': ['report_student_interview.view'],
  'Reports > Inquiry Report': ['report_inquiry.view'],
  'Reports > Online Students': ['report_online_students.view'],
  'Reports > Pune Inquiries': ['report_suvidya_pune.view'],
  'Reports > Full Attendance Report': ['report_attendance.view'],
  'Reports > Final Exam': ['report_final_exam.view'],
  'Reports > Fees Report': ['report_fees.view'],
...
function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  const getActiveFromPath = (path: string) => {
    ...
    if (path.startsWith('/dashboard/fee-details')) return 'Admin/Accounts';
