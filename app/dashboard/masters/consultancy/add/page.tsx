            ...
            <SectionCard title="Consultancy Information" icon={<svg className="w-3.5 h-3.5 text-[#2E3093]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5" /></svg>}>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-2 mt-1">
                ...
                <div className="md:col-span-3">
                  ...
                  <textarea className={textareaCls} rows={2} value={form.Remark} onChange={e => handleChange('Remark', e.target.value)} placeholder="Company Business" />
                </div>
            ...
            <SectionCard title="Student Details" icon={<svg className="w-3.5 h-3.5 text-[#2E3093]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.5 20.118a7.5 7.5 0 0115 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.5-1.632z" /></svg>}>
              {!consultancyId && (
                <div className="bg-amber-50 border border-amber-200 rounded-lg px-4 py-3 text-sm text-amber-700">
                  Please save consultancy details first to view student details.
                </div>
              )}
                    ...
                    <tbody>
                      <tr>
                        <td colSpan={9} className="px-4 py-6 text-center text-gray-400 text-xs">
                          {consultancyId ? 'No student details found' : 'Save consultancy to load student details'}
                        </td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-2 mt-1">
                  ...
                  <div>
                    ...
                    <select className={selectCls} value={followupForm.Course} onChange={e => setFollowupForm(f => ({ ...f, Course: e.target.value }))}>
                      <option value="">--Select--</option>
                      {courses.map((c, idx) => <option key={c.Course_Id ?? idx} value={c.Course_Name}>{c.Course_Name}</option>)}
                    </select>
                  </div>
                  <div>
