...
export default function LibraryBookPage() {
  const { canView, canCreate, canUpdate, canDelete, loading: permLoading } = useResourcePermissions('library_book');
  /* ---- Form state ---- */
...
if (!canView) return <AccessDenied message="You do not have permission to view library books." />;
