...
import type { MonthlyRow, CashflowTxn } from '../shared/types';
...
export function ProjectsTab() {
  return <MonthlyTab apiPath="/api/finance/projects" title="Accent Projects — Monthly Performance" cashflowDepartment="PROJECT ACCENT" />;
}
