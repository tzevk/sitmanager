                      ...
                      <tr key={r.Inquiry_Id} className={`border-b border-slate-100 transition-colors hover:bg-blue-50/50 ${idx % 2 === 1 ? 'bg-slate-50/40' : 'bg-white'}`}>
                          ...
                          <td className="py-1.5 px-3">
                            <div className="flex items-center justify-center gap-0.5">
                              ...
                              {/* View — opens the admin admission form, which is fully editable inline
                                  (there is no separate read-only view / edit split anymore) */}
                              <button
                                title={r.IsDraft ? 'View in-progress admission form' : 'View & edit admission form'}
