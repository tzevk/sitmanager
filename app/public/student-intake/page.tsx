...
export default function PublicStudentIntakePage() {
  // Static page retained only for backward compatibility; recommends using tokenized link.
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/public/student-intake', {
        method: 'POST',
