...
\`${studentMasterTable}\` sm
    ...
    return NextResponse.json({
      ...
      photo:                 payload.photo         || '',
      razorpayPaid:          Boolean(payload.razorpayPaid),
      razorpayPaymentId:     String(payload.razorpayPaymentId || ''),
      razorpayOrderId:       String(payload.razorpayOrderId  || ''),
      razorpayAmount:        payload.razorpayAmount != null ? Number(payload.razorpayAmount) : null,
      paymentSubMethod:      payload.paymentSubMethod || '',
      neftTransactionNumber: String(payload.neftTransactionNumber || ''),
      neftAmount:            payload.neftAmount != null ? Number(payload.neftAmount) : null,
      neftBankDetails:       payload.neftBankDetails || null,
      paymentConfirmDate:            payload.paymentConfirmDate || '',
      paymentConfirmName:            payload.paymentConfirmName || '',
      paymentConfirmMode:            payload.paymentConfirmMode || '',
      paymentConfirmTransactionNo:   payload.paymentConfirmTransactionNo || '',
      paymentConfirmAmount:          payload.paymentConfirmAmount != null ? Number(payload.paymentConfirmAmount) : null,
