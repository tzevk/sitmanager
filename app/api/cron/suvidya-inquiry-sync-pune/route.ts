...
async function runSync(req: NextRequest) {
  ...
  const maxRecordsRaw = Number(req.nextUrl.searchParams.get('maxRecords') || process.env.SUVIDYA_PUNE_INQUIRY_SYNC_MAX_RECORDS || process.env.SUVIDYA_INQUIRY_SYNC_MAX_RECORDS || '0');
